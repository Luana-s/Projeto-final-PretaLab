...
import homeImg from '../assets/inicio.svg'
    ...
    <>
     ...
     <div className={styles.homeContainer}>
      <div className={styles.cardContainer}>
        ...
        <p className={styles.cardText}>Eu conto um pouquinho sobre mim, minha formação, a história da minha carreira, gostos e curiosidades.</p>
      </div>
      <div className={styles.cardContainer}>
